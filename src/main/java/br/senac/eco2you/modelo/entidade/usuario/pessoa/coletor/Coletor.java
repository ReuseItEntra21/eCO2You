...
public class Coletor extends Pessoa implements Serializable {
	...
	public Coletor(String nome, String sobrenome, String apelido, Date dataNascimento, String senha, String cpf, String email) {
		super(nome, sobrenome, apelido, dataNascimento,  senha, cpf, email);
		depositos = new ArrayList<>();
