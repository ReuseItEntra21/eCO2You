				...
				<c:forEach var="deposito" items="${deposito}">
					<div class="item-deposito">
						...
						<div class="container-acoes">
							<a id="lapis" href="editar-deposito?id=<c:out value='${deposito.id}'/>"><svg><%@include file="../../images/lapis.jsp"%></svg></a>
							<a id="lixeira" href="deletar?id=<c:out value='${deposito.id}'/>"><svg><%@include file="../../images/trash.jsp"%></svg></a>
						</div>
					</div>
				</c:forEach>
			</div>
